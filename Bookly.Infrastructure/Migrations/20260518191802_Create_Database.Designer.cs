...
namespace Bookly.Infrastructure.Migrations
{
    ...
    [Migration("20260518191802_Create_Database")]
            ...
            modelBuilder.Entity("Bookly.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookly.Domain.Shared.Money", "AmenetiesUpCharge", b1 =>
                        {
                            ...
                            b1.Property<decimal>("Amount")
                                .HasColumnType("numeric")
                                .HasColumnName("ameneties_up_charge_amount");

                            b1.Property<string>("Currency")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("ameneties_up_charge_currency");
